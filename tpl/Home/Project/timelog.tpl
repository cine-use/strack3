...
<block name="head-title"><title>{$Think.lang.Timelog_Title}</title></block>

<block name="head-js">
  <if condition="$is_dev == '1' ">
    <script type="text/javascript" src="__JS__/src/home/timelog.js"></script>
    <else/>
    <script type="text/javascript" src="__JS__/build/home/timelog.min.js"></script>
  </if>
</block>
<block name="head-css">
  <script type="text/javascript">
      var TimelogPHP = {
          'getTimelogGridData': '{:U('Home/Timelog/getTimelogGridData')}',
...
<block name="main">
  ...
  <div class="projpage-main">
    <div class="projtable-content">
      ...
      <div id="grid_datagrid_main" class="entity-datalist timelog-m-grid">
        <div id="tb_grid" class="proj-tb tb-padding-grid grid-toolbar" data-grid="main_datagrid_box" data-page="{$page}" data-schemapage="{$page}" data-moduleid="{$module_id}" data-maindom="grid_datagrid_main" data-bardom="grid_filter_main" data-projectid="{$project_id}">
          ...
          <eq name="view_rules.toolbar__create" value="yes">
            <div class="st-buttons-sig st-buttons-blue aign-left">
              <a href='javascript:;' onclick="obj.timelog_add(this);" data-lang="{$module_name}">
                <i class="icon plus"></i>
            ...
            <div class="ui dropdown st-dropdown aign-left">
              ...
              <div class="menu edit-menu">
                ...
                <eq name="view_rules.toolbar__edit__batch_edit" value="yes">
                  <a href="javascript:;" class="item" onclick="obj.timelog_edit(this);" data-lang="{$Think.lang.Batch_Edit}">
                ...
                <eq name="view_rules.toolbar__edit__batch_delete" value="yes">
                  <div class="divider"></div>
                  <a href="javascript:;" class="item" onclick="obj.delete_timelog(this);">
