...
<block name="head-title"><title>{$Think.lang.File_Commit_Title}</title></block>

<block name="head-js">
    <if condition="$is_dev == '1' ">
        <script type="text/javascript" src="__JS__/src/home/file_commit.js"></script>
        <else/>
        <script type="text/javascript" src="__JS__/build/home/file_commit.min.js"></script>
    </if>
</block>
<block name="head-css">
    <script type="text/javascript">
        var FileCommitPHP = {
            'getFileCommitGridData': '{:U('Home/FileCommit/getFileCommitGridData')}',
            'deleteFileCommit': '{:U('Home/FileCommit/deleteFileCommit')}'
        };
                ...
                <div id="tb_grid" class="proj-tb tb-padding-grid grid-toolbar" data-grid="main_datagrid_box" data-page="{$page}" data-schemapage="{$page}" data-moduleid="{$module_id}" data-maindom="grid_datagrid_main" data-bardom="grid_filter_main" data-projectid="{$project_id}">
                    ...
                    <eq name="view_rules.toolbar__create" value="yes">
                        <div class="st-buttons-sig st-buttons-blue aign-left">
                            <a href='javascript:;' onclick="obj.file_commit_add(this);" data-lang="{$module_name}">
                                <i class="icon plus"></i>
                        ...
                        <div class="ui dropdown st-dropdown aign-left">
                            ...
                            <div class="menu edit-menu">
                                ...
                                <eq name="view_rules.toolbar__edit__batch_edit" value="yes">
                                    <a href="javascript:;" class="item" onclick="obj.file_commit_edit(this);" data-lang="{$Think.lang.Batch_Edit}">
                                ...
                                <eq name="view_rules.toolbar__edit__batch_delete" value="yes">
                                    <div class="divider"></div>
                                    <a href="javascript:;" class="item" onclick="obj.file_commit_delete(this);">
