...
class FillAdminSchedulePageAuthData extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function up()
    {
        ...
        $this->savePageAuth($adminSchedulePageRows);
