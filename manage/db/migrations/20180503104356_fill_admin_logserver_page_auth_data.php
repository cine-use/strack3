...
class FillAdminLogserverPageAuthData extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function up()
    {
         ...
         * 后台-日志服务器设置页面
         */
        $adminLogServerPageRows = [
            'page' => [
                'name' => '日志服务器设置',
                'code' => 'logServer',
                'lang' => 'Log_Server_Setting',
                'page' => 'admin_logserver_index',
                'menu' => 'admin_menu',
        ...
        $this->savePageAuth($adminLogServerPageRows);
