...
class FillAppendDefaultStatusListRulesData extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function up()
    {
        ...
        $getStatusListNodeRows = [
            [
                ...
                'project_id' => 0,
                'module_id' => 0,
                'rules' => 'Home/Widget/getStatusList',
                'uuid' => Webpatser\Uuid\Uuid::generate()->string
            ]
        ];
        $this->table('strack_auth_node')->insert($getStatusListNodeRows)->save();

        /**
         * 获取状态列表分组
         */
        $getStatusListGroupNodeRows = [
            [
                'auth_group_id' => 10,
                'auth_node_id' => 689,
                'uuid' => Webpatser\Uuid\Uuid::generate()->string
        ...
        $this->table('strack_auth_group_node')->insert($getStatusListGroupNodeRows)->save();
    }
