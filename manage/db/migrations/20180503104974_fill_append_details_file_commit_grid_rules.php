...
class FillAppendDetailsFileCommitGridRules extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function up()
    {
        $parentData = $this->fetchRow('SELECT id FROM strack_page_auth WHERE code="file_commit" and page = "home_details_index"');
