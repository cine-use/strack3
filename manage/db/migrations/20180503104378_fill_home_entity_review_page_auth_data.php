...
class FillHomeEntityReviewPageAuthData extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function up()
    {
        ...
        $this->savePageAuth($homeEntityPageRows);
        ...
        $this->table('strack_auth_field')->insert($authFieldRows)->save();
    }
