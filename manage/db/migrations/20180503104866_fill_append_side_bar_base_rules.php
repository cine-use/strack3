...
class FillAppendSideBarBaseRules extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    public function up()
    {
        ...
        $pageAuthLinkData = $this->fetchAll('SELECT id,page,param FROM strack_page_auth WHERE code="tab_bar" and page not in ("home_details_index")');
        ...
        foreach ($pageAuthLinkData as $item) {
            ...
            $this->savePageAuth($baseButtonPageAuthRows, $item['id']);
        }
    }
