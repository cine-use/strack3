        ...
        Strack.load_grid_columns('#table_grid', {
            ...
            var filter_data = {
                filter: {
                    ...
                    request: [
                        {field : 'project_id', value : param.project_id, condition : 'EQ', module_code : param.module_code, table : 'Entity'},
                        {field : 'module_id', value : param.module_id, condition : 'EQ', module_code : param.module_code, table : 'Entity'}
                    ],
